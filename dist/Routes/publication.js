...
router.post("/searchByAll", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
router.delete("/delete/:id", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      yield image_1.Image.destroy({
        where: { pub_id: pubId },
      });
      yield reaction_1.Reaction.destroy({
        where: { pub_id: pubId },
      });
      yield temoignage_1.Temoignage.destroy({
        where: { pub_id: pubId },
      });
      var notifToSuppr = [];
      ...
      notifToSuppr.map((notif) =>
        __awaiter(void 0, void 0, void 0, function* () {
          yield lecture_1.Lecture.destroy({
        ...
        if (Req.entreprise != null) {
          ...
          if (req.file != undefined) {
            yield image_1.Image.create({
              pub_id: pub.pub_id,
              image: `https://localhost:3000/Images/${req.file.filename}`,
            });
          }
        } else {
          const pub = yield publication_1.Publication.create({
