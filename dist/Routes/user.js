...
const username_splitter_1 = __importDefault(
  require("../Config/username.splitter")
);
      ...
      if (Req.query != null) {
        ...
        if (users.length > 0) {
          ...
          if (usersWithValidPassword.length === 1) {
            ...
            res.status(202).json({
              message:
                "Plusieurs utilisateurs avec le même mot de passe trouvés",
            });
          } else {
          ...
          if (us) {
            ...
            if (use) {
              res
                .status(500)
                .json({ message: "Veuillez verifier votre email" });
            } else {
              res
                .status(500)
                .json({ message: "Aucun utilisateur correpondant" });
            }
          }
        }
      }
...
router.post("/authByGoogle", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const Req = req.body;
    try {
      if (Req.email != null) {
...
router.delete("/delete/:id", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const userId = parseInt(req.params.id, 10);
    try {
      const deletedCount = yield user_1.User.destroy({
...
router.post("/modify/:id", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const Req = req.body;
    try {
      const selectedUser = yield user_1.User.findOne({
        where: { user_id: userId },
      });
      if (selectedUser) {
...
router.post("/GetPassword/:id", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const userId = parseInt(req.params.id, 10);
    try {
...
router.post("/GetUsername/:id", (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const userId = parseInt(req.params.id, 10);
    try {
      const response = yield user_1.User.findOne({
